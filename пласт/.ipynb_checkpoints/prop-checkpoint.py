...
def t_p(t, p, fluid):
    ...
    res = RP.REFPROPdll(fluid, 'TP', 'T;P;H;S;QMASS;D;TCX;VIS;PRANDTL', iUnits, iMass, iFlag, t + 273.15, p * 10 ** 6, comp)
    if res.q <= 0:
        q = 0
    elif res.q >= 1:
        q = 1
    ...
    return {'T': res.Output[0] - 273.15, 'P': res.Output[1] / 10 ** 6, 'H': res.Output[2] / 1000,
            'S': res.Output[3] / 1000, 'Q': q,'ro':res.Output[5],'lamda':res.Output[6],'nu':res.Output[7]/res.Output[5],'Pr':res.Output[8]}
